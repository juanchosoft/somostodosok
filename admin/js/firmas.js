...
var FIRMAS = {
    ...
    save: function() {
       ...
       q.acepto_terminos = $('input[name="acepto_terminos"]').is(':checked') ? 'si' : 'no';
        ...
        var mensaje = `Hola señor(a) ${q.nombre} acaba de registrarse para recoger firmas en el departamento  ${departamento} en el municipio ${municipio} en la vereda ${vereda}. Muchas gracias por su interés, en un momento recibiras via whatapp la planilla.`;
        var mensajeSinVereda = `Hola señor(a) ${q.nombre} acaba de registrarse para recoger firmas en el departamento   ${departamento} en el municipio ${municipio}. Muchas gracias por su interés, en un momento recibiras via whatapp la planilla.`;
        var mensajePais = `Hola señor(a) ${q.nombre} acaba de registrarse para recoger firmas desde el pais ${pais}. Muchas gracias por su interés, en un momento recibiras via whatapp la planilla.`;
