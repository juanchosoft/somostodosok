...
(function($) {
	...
	$('#clock').countdown('2023/08/27 08:50:56') /* change here your "countdown to" date */
    ...
    /* Countdown1 Timer - The Final Countdown1 */
	$('#clock1').countdown('2023/06/01 08:50:56') /* change here your "countdown to" date */
	.on('update.countdown', function(event) {
		var format = '<span class="counter-number">%D<br><span class="timer-text">Días</span></span><span class="counter-number">%H<br><span class="timer-text">Horas</span></span><span class="counter-number">%M<br><span class="timer-text">Minutos</span></span><span class="counter-number">%S<br><span class="timer-text">Segundos</span></span>';
		$(this).html(event.strftime(format));
	})
    ...
    $("#registrationForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            ...
            rformError();
            rsubmitMSG(false, "Por favor llene todos los campos!");
        } else {
    ...
    $("#newsletterForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            nformError();
            nsubmitMSG(false, "Por favor llene todos los campos!");
        } else {
            // everything looks good!
            event.preventDefault();
            nsubmitForm();
    ...
    $("#contactForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            cformError();
            csubmitMSG(false, "Por favor llene todos los campos!");
        } else {
            // everything looks good!
            event.preventDefault();
            csubmitForm();
